<?php
  ...
  $popup = getCookiePopup($lang, $NL, $api, $root);
...
<head>
  ...
  <?php if(isset($_COOKIE['popup'])): ?>
    <?php if($_COOKIE['popup'] == '2'): ?>
      <script async src="https://www.googletagmanager.com/gtag/js?id=UA-176153420-1"></script>
      <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-176153420-1');
      </script>
    <?php endif; ?>
  <?php endif; ?>
</head>
...
<?php if($popup != false): ?>
  <div id="cookiePopup" class="cookie-popup">
    <div class="popup-content">
      ...
      <div class="content">
        <span><?=$popup[0]['content']?></span>
      </div>
      <?php if($lang == $NL): ?>
        <div id='accept' class="btn">
          <a>Accepteren</a>
        </div>
      <?php else: ?>
        <div id='accept' class="btn">
